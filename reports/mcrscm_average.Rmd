...
params:
  ...
  dir:
    ...
    value: "/home/danielred/data/programs/mcrs_scm/OUT/bubble_upd4test4_80_230/"
  ssh:
    label: SSH address in format of user@domain:port
    value: "danielred@10.30.0.14"
  ssh_key:
...
table_long$type <- factor(table_long$type,
       levels = c(paste0("enz", 1:p$par_noEA-1), "par"),
       labels =c(1:p$par_noEA, "parazite") )
