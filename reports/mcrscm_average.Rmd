...
params:
  cache.path:
    ...
    value: "/var/www/html/oktato/A7long.3_26_281/report_cache"
  dir:
    label: Path to data dir
    value: "/home/danielred/data/programs/mcrs_scm/OUT/A7long.3_26_281/"
  ssh:
...
pf <- get_file("parameters.txt", mergepath(params$dir, "SAVE/"), ssh=ssh, ssh_key = params$ssh_key)
  if(!is.na(pf)){
    ...
    try(write.table(t, file=mergepath(params$cache.path, "parameters.tsv"), sep="\t", col.names = F, row.names = F))
